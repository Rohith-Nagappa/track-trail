// WE ARE USING FONT AWESOME ICONS. TO USE FONT AWESOME FIRSTLY PASTE LINK OF FONT AWESOME IN index.html
...
export const medical = <i class="fa-light fa-briefcase-medical"></i>
